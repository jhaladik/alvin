#!/usr/bin/env python3
"""
Local CPU Training Script
Modified version of quickstart.py for CPU training (no GPU check)
"""
import os
import sys
import subprocess
...
def check_cpu():
    ...
    print("WARNING: Training on CPU (AMD)")
...
def train_model():
    """Train the model"""
    print_banner("Step 4: Model Training (CPU - This Takes ~30-60 min)")

    print("🔥 Training on CPU...")
    print("   You'll see real-time progress below")
    print("   ⚠️  This will use significant CPU resources")
    print()
...
def show_results():
    ...
    print()
    print("⏭️  Next steps:")
    print("  1. Test model: python -c \"import onnxruntime; ...\"")
